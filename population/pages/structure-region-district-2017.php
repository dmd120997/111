...
<title>Структура чисельності населення Виноградівської ОТГ серед області та району(за 2017рік)</title>
...
<script type="text/javascript">
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM `population` WHERE `id` >=2");
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Структура чисельності населення Виноградівської ОТГ серед області та району(за 2017рік)</h1>
          </div>
