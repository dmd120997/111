...
include($_SERVER['DOCUMENT_ROOT'].'/population/functions.php');
?>
        ...
        <form class="form-horizontal" action="functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
          ...
          <div class="collapse" id="collapseExample">
            <div class="card card-body">
                  <fieldset>
                      <div class="row">
                          <label class="col-md-8 control-label" for="filebutton">Виберіть файл для оновлення (Чисельність населення Виноградівської ОТГ.csv)</label>
                          <div class="col-10">
